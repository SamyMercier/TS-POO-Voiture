...
var MoteurElectrique = /** @class */ (function (_super) {
    ...
    function MoteurElectrique(vitesse, kilometrage, vitesseRechargement) {
        var _this = _super.call(this, vitesse, kilometrage) || this;
        _this.faireAttendre = function () {
            console.log("..........");
        };
        _this._vitesseRechargement = vitesseRechargement;
        return _this;
    }
    Object.defineProperty(MoteurElectrique.prototype, "vitesseRechargement", {
        get: function () {
            return this._vitesseRechargement;
        },
        set: function (vitesseRechargement) {
